...
export const demoAssignments: DemoAssignment[] = [
  ...
  // Исследования и обработка информации (12 заданий)
  ...
  { id: 'demo-assign-5-2', skill_id: 'demo-skill-5', title: 'Анализ конкурентов', level: 'Basic', order_index: 2, task_id: null },
  { id: 'demo-assign-5-3', skill_id: 'demo-skill-5', title: 'Извлечение данных из источников', level: 'Basic', order_index: 3, task_id: null },
  { id: 'demo-assign-5-4', skill_id: 'demo-skill-5', title: 'Валидация информации', level: 'Basic', order_index: 4, task_id: null },
  { id: 'demo-assign-5-5', skill_id: 'demo-skill-5', title: 'Синтез информации из разных источников', level: 'Pro', order_index: 5, task_id: null },
  { id: 'demo-assign-5-6', skill_id: 'demo-skill-5', title: 'Создание аналитического отчета', level: 'Pro', order_index: 6, task_id: null },
  { id: 'demo-assign-5-7', skill_id: 'demo-skill-5', title: 'Поиск трендов и паттернов', level: 'Pro', order_index: 7, task_id: null },
  { id: 'demo-assign-5-8', skill_id: 'demo-skill-5', title: 'Fact-checking с AI', level: 'Pro', order_index: 8, task_id: null },
