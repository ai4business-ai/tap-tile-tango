        ...
        <div className="glass-header rounded-3xl px-6">
          ...
          <div className="flex items-center justify-between py-3">
            ...
            <div className="flex flex-col">
              <span className="font-source-serif text-base font-semibold text-deep-purple text-gray-900">
                hakku.ai
              </span>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 text-center max-w-[100px]">
              <p className="text-[10px] font-medium leading-tight text-gray-900">
            ...
            <button onClick={() => setMenuOpen(!menuOpen)} className={`w-10 h-10 rounded-full bg-white/30 backdrop-blur-sm flex items-center justify-center border border-white/40 hover:bg-white/40 transition-all ${shouldHighlightAvatar ? 'ring-2 ring-orange-500 animate-pulse' : ''}`}>
              {user?.user_metadata?.avatar_url ? <Avatar className="h-10 w-10">
                ...
                </Avatar> : <span className="text-deep-purple text-sm font-semibold text-gray-900">
                  {getInitials()}
                </span>}
            </button>
          </div>
          ...
          {menuOpen && <nav className="py-4 space-y-2 border-t border-white/20">
              {user ? <>
                  <div className="pb-2">
