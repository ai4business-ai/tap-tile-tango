    ...
    "research": {
      ...
      levels: {
        "Basic": {
          ...
          assignments: [
            "1.1.1 Найти и обобщить информацию по рабочему вопросу за 5 минут",
            "1.1.2 Проанализировать Word/PDF документ объемом 20+ страниц и создать executive summary на 1 страницу",
            "1.1.3 Проверить факты и данные через множественные источники с оценкой достоверности",
            "1.1.4 Создать саммари документа/статьи"
          ]
        },
        "Pro": {
          status: "planned",
          assignments: [
            "1.2.1 Освоить Deep Research: научиться формулировать исследовательские вопросы и использовать режим глубокого поиска для комплексного анализа",
            "1.2.2 Объединить и проанализировать информацию из 5+ документов разных форматов (PDF, Excel, Word) по одному проекту",
            "1.2.3 Создать сравнительный анализ 3+ решений/подходов с матрицей критериев",
            "1.2.4 Построить базу знаний по проекту с системой тегов и быстрого поиска"
          ]
        },
        "AI-Native": {
          status: "planned",
          assignments: [
            "1.3.1 Создать специализированного GPT/агента для анализа документов вашей отрасли",
            "1.3.2 Разработать систему автоматической проверки фактов и валидации данных",
            "1.3.3 Построить персональную систему knowledge mining из корпоративных документов"
          ]
        }
      }
    }
